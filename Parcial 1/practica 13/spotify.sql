...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-03-2025 a las 01:34:58
...
INSERT INTO `artistascanciones` (`id`, `artista_id`, `cancion_id`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 1, 3),
(4, 1, 4),
...
INSERT INTO `playlist` (`id`, `nombre`, `usuario_id`, `duracion`, `totalcancion`, `descripcion`, `publico`) VALUES
(1, 'llorar', 6, '00:44:00', 10, 'llorar', 0),
(2, 'pop bailable', 3, '00:44:00', 10, 'pop bailable', 0),
(3, 'duchaa', 7, '00:44:00', 10, 'duchaa', 0),
(4, 'dormir', 4, '00:44:00', 10, 'dormir', 0),
(5, 'perreo', 5, '00:44:00', 10, 'perreo', 0);
...
INSERT INTO `playlistcanciones` (`id`, `playlist_id`, `cancion_id`, `usuario_id`) VALUES
(1, 1, 41, 6),
(2, 2, 24, 3),
(3, 3, 18, 7),
(4, 4, 48, 4),
